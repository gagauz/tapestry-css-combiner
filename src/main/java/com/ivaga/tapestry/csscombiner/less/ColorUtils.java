...
class ColorUtils {
	 ...
	 * 
	 * @param r
	 *            red in range of 0 to 255.0
	 * @param g
	 *            green in range of 0 to 255.0
	 * @param b
	 *            blue in range of 0 to 255.0
	 * @param a
	 *            alpha in range of 0.0 to 1.0
	 * @return color value as long
	 */
	static double rgba(double r, double g, double b, double a) {
		return Double.longBitsToDouble(
				Math.round(a * 0xFFFF) << 48 | (colorLargeDigit(r) << 32) | (colorLargeDigit(g) << 16) | colorLargeDigit(b));
	}
	 ...
	 *            hue value
	 * @param m1
	 *            value 1 in range of 0.0 to 1.0
	 * @param m2
	 *            value 2 in range of 0.0 to 1.0
	 ...
	 * @param threshold
	 *            percentage 0-100% specifying where the transition from "dark"
	 *            to "light" is
	 * @return a color value as long
	 */
