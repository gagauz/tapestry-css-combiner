...
class CssFormatter implements Cloneable {
	...
	/**
	 * If already was write a character directive. Such directive can write only
	 * once.
	 * 
	...
	/**
	 * Release an output buffer, return the content and restore the previous
	 * output.
	 * 
	...
	/**
	 * Release an output buffer, restore the previous output and add the content
	 ...
	 * 
	 * @param variables
	 *            the variables, can be null if the current rule has no
	 *            parameters.
	 */
	 ...
	 *            the parameters
	 * @param isDefault
	 *            if the default case will be evaluated, in this case the
	 *            expression "default" in guard is true.
	 */
	...
	/**
	 * If the state of "default" was requested since the last guard parameter
	 * was added.
	 * 
	...
	/**
	 * The counter of the variable stack changes. This is an optimizing that
	 * some expression does not need reevaluate if this ID has not changed.
	 * 
	 * @return the id
	 */
	int stackID() {
	 ...
	 *            the color value
	 * @param hint
	 *            the original spelling of the color if not calculated
	 * @return this
	 */
	...
	/**
	 * Special hack for property "font" which contains a value
	 ...
	 * 
	 * @param msg
	 *            the comment including the comment markers
	 * @return a reference to this object
	 */
